...
import (
	...
	"github.com/example/myapp/api/internal/modules/widget/domain"
)
...
import (
	...
	"github.com/example/myapp/api/internal/modules/widget/domain"
	"github.com/example/myapp/api/internal/platform/apperr"
)
...
import (
	...
	"github.com/example/myapp/api/internal/modules/widget/app"
	"github.com/example/myapp/api/internal/modules/widget/domain"
	"github.com/example/myapp/api/internal/platform/authmw"
	"github.com/example/myapp/api/internal/platform/httputil"
	"github.com/example/myapp/api/internal/platform/orgmw"
)
...
import "github.com/example/myapp/api/internal/modules/widget/domain"
...
import (
	"github.com/example/myapp/api/internal/modules/widget/app"
	"github.com/example/myapp/api/internal/modules/widget/infra"
	"github.com/example/myapp/api/internal/modules/widget/ports"
	"github.com/example/myapp/api/internal/platform/database"
)
