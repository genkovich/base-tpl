...
- **Module path:** `github.com/example/myapp/api`, **Go 1.25**.
...
├── go.mod          # module github.com/example/myapp/api, go 1.25
...
- Module path matches the repo: `github.com/example/myapp/api`. Acronyms keep one case (`OrgID`,
