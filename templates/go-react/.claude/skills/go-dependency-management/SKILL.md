...
- **Module path & toolchain:** `github.com/example/myapp/api`, `go 1.25.0`. New imports use this module prefix for internal packages (`github.com/example/myapp/api/internal/...`).
