// MyApp API server: config → logging → database → auth → storage →
...
import (
	...
	"github.com/example/myapp/api/internal/platform/config"
	"github.com/example/myapp/api/internal/platform/database"
	"github.com/example/myapp/api/internal/platform/logging"
