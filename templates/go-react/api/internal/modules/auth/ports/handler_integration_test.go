...
import (
	...
	"github.com/example/myapp/api/internal/modules/auth"
	"github.com/example/myapp/api/internal/modules/auth/app"
	"github.com/example/myapp/api/internal/modules/auth/infra"
	"github.com/example/myapp/api/internal/modules/auth/ports"
	"github.com/example/myapp/api/internal/modules/user"
	"github.com/example/myapp/api/internal/platform/authmw"
	"github.com/example/myapp/api/internal/platform/database"
	"github.com/example/myapp/api/internal/platform/database/dbtest"
	"github.com/example/myapp/api/internal/platform/storage"
	"github.com/example/myapp/api/internal/server"
	"github.com/example/myapp/api/migrations"
)
