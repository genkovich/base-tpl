...
func TestLoad_CustomValues(t *testing.T) {
	...
	t.Setenv("CORS_ALLOWED_ORIGINS", "https://app.myapp.dev")
	...
	if cfg.CORSAllowedOrigins != "https://app.myapp.dev" {
		t.Errorf("expected CORSAllowedOrigins=https://app.myapp.dev, got %s", cfg.CORSAllowedOrigins)
	}
}
